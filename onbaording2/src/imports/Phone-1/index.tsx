import imgImage from "./c44a3311576d0c1a25b5e159d62b73356fd98815.png";

function Image() {
  return (
    <div className="absolute h-[1084px] left-[-37px] top-[-211px] w-[432px]" data-name="Image">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Black',sans-serif] leading-[31.2px] not-italic relative shrink-0 text-[#1c1d1b] text-[26px] whitespace-nowrap">Grow Your Business</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[22.4px] not-italic relative shrink-0 text-[#696b68] text-[14px] w-[327px]">Manage payments, track expenses, and empower your business with powerful financial tools.</p>
      </div>
    </div>
  );
}
