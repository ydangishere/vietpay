import imgImage from "./f6ebc872c410e4110e279f4549e1365bb6be1ff5.png";

function Image() {
  return (
    <div className="absolute h-[1103px] left-[-11px] top-[-171px] w-[429px]" data-name="Image">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Black',sans-serif] leading-[31.2px] not-italic relative shrink-0 text-[#1c1d1b] text-[26px] whitespace-nowrap">{`Secure & Reliable`}</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[22.4px] not-italic relative shrink-0 text-[#696b68] text-[14px] w-[327px]">Bank-grade encryption and biometric authentication keep your money safe at all times.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="drop-shadow-[0px_4px_7px_rgba(218,41,28,0.33)] h-[52px] relative rounded-[14px] shrink-0 w-[327px]" style={{ backgroundImage: "linear-gradient(170.964deg, rgb(218, 41, 28) 0%, rgb(163, 31, 21) 100%)" }} data-name="PrimaryBtn">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Bold',sans-serif] leading-[22.5px] not-italic relative shrink-0 text-[15px] text-center text-white whitespace-nowrap">Get Started</p>
      </div>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-0 pb-[64px] px-[24px] top-[539.64px] w-[375px]" data-name="Container">
      <Container5 />
      <Container6 />
    </div>
  );
